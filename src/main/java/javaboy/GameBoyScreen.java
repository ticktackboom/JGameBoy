...
/**
 * This class is used when javaboy.JavaBoy is run as an application
...
class GameBoyScreen extends Frame implements ActionListener,
    ...
    /**
     * Creates the javaboy.JavaBoy interface, with the specified title text
     */
    ...
    /**
     * Sets the current javaboy.GraphicsChip object which is responsible for drawing the screen
     */
...
//	applet.gameBoyPrinter = new javaboy.GameBoyPrinter();

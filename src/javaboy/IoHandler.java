...
class IoHandler {
    ...
    /**
     * Create an javaboy.IoHandler for the specified CPU
     */
...
//  System.out.println("Copied 16 bytes from " + javaboy.JavaBoy.hexWord(dmaSrc) + " to " + javaboy.JavaBoy.hexWord(dmaDst));
...
//   case 0x44 :
//    System.out.println("Checking LCDY at " + javaboy.JavaBoy.hexWord(dmgcpu.pc));
//    return registers[num];
...
//    System.out.println("D:" + data);
            ...
            case 0x40:           // LCDC
//    System.out.println("LCDC write at " + javaboy.JavaBoy.hexWord(dmgcpu.pc) + " = " + javaboy.JavaBoy.hexWord(data));
            ...
            case 0x41:
//    System.out.println("STAT set to " + data + " lcdc is " + javaboy.JavaBoy.unsign(registers[0x44]) + " pc is " + javaboy.JavaBoy.hexWord(dmgcpu.pc));
                registers[0x41] = (byte) data;
                break;

            case 0x42:           // SCY
//    System.out.println("SCY set to " + data + " lcdc is " + javaboy.JavaBoy.unsign(registers[0x44]) + " pc is " + javaboy.JavaBoy.hexWord(dmgcpu.pc));
                registers[0x42] = (byte) data;
                break;

            case 0x43:           // SCX
//    System.out.println("SCX set to " + data + " lcdc is " + javaboy.JavaBoy.unsign(registers[0x44]) + " pc is " + javaboy.JavaBoy.hexWord(dmgcpu.pc));
                registers[0x43] = (byte) data;
                break;

            case 0x46:           // DMA
                int sourceAddress = (data << 8);
//    System.out.println("DMA Transfer initiated from " + javaboy.JavaBoy.hexWord(sourceAddress) + "!");
